...
<h1 class="display-5 font-weight-700 bg-white text-left text-orange pt-20 pb-20">Buy USB Token for DSC
</h1>
<p class="text-left display-5 pb-5 font-16 font-weight-400 text-dark px-20"><i class="fa fa-check-square-o text-green font-weight-500" aria-hidden="true"></i> Extra layer of security for online transactions.</p>
<p class="text-left display-5 pb-5 font-16 font-weight-400 text-dark px-20"><i class="fa fa-check-square-o text-green font-weight-500" aria-hidden="true"></i> Conjunction with a password or PIN to authenticate a user.</p>
<p class="text-left display-5 pb-5 font-16 font-weight-400 text-dark px-20"><i class="fa fa-check-square-o text-green font-weight-500" aria-hidden="true"></i> Tokens are not susceptible to viruses or hacking.</p>
<p class="text-left display-5 pb-5 font-16 font-weight-400 text-dark px-20"><i class="fa fa-check-square-o text-green font-weight-500" aria-hidden="true"></i> USB tokens are secure way to store and use</p>
<p class="text-left display-5 pb-5 font-16 font-weight-400 text-dark px-20"><i class="fa fa-check-square-o text-green font-weight-500" aria-hidden="true"></i> USB tokens are small and portable, are easy to carry</p>
...
<div class="col-xl-6 text-dark">
    <div class="container pl-30 pr-30">
        ...
        <span class="fa fa-star text-sun"></span>
        <span class="fa fa-star text-sun"></span> -->
        <img class="d-block w-100 mt-20" src="{{ asset('dist/img/home-banner/usb-token.jpg') }}" height="350" width="575" alt="Steps for Digital Signature Registration">
        <div class="mt-20  font-15 text-justify">
            <h3 class="py-20 display-6 font-weight-700 text-orange text-left">What Is USB Token for DSC</h3>
            <div class="row text-dark font-15 text-justify">
                <div class="col-sm-12 mb-20">
                    <p>A Digital Signature Token or USB Token is a password-protected physical device used to establish personal identity. It enables users to access the network without a password. It helps improve security by authenticating user access to the network.</p>
                    <p class="mt-20">The digital signature token comes with a software that allows authorized users to open and use their digital signatures. They make the process of remote signing more secure and easier with a two-factor authentication process for validation, secure local and remote desktop login, people are now enjoying the liberty to perform their signing operation from remote locations. </p>
                    <p class="mt-20">As the Controller of Certifying Authorities (CCA) has made it compulsory to have digital signature tokens along with DSCs, it is important to know different types of tokens.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="bg-grey-light-5 py-60 text-dark">
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
                <h3 class="py-20 display-6 font-weight-700 text-orange text-left">Types of USB Token</h3>
                <div class="col-sm-12 mb-20">
                    <h5 class="mb-5 font-16 font-weight-600">
                        Proxkey: 
                    </h5>
                    <p>The Proxkey Digital Signature / USB token is a hardware cryptographic token. The two-factor authentication of Proxkey makes it the most secure digital signature token. The involvement of both private and public keys makes the entire signing process smooth. Also, the private key is stored on the chip embedded inside the token. Thus, it can't be exported.</p>
                </div>
                <div class="col-sm-12 mb-20">
                    <h5 class="mb-5 font-16 font-weight-600">
                        mToken
                    </h5>
                    <p>A USB mToken helps in assuring or identifying the user's ‘Identity Digitally’. It is a plug and play digital signature token. mToken helps to enhance digital security. It also allows users to perform cloud signing in a seamless manner.</p>
                    <p class="mt-20">If you are looking for a digital signature token for remote signing from a trusted Certifying Authority, you are in the right place. digisignature.org, being the largest Certifying Authority in India provides you with the best digital signature certificates and tokens as per your requirements.</p>
                </div>
                <div class="col-sm-12 mb-20">
                    <h5 class="mb-5 font-16 font-weight-600">
                        ePass 2003
                    </h5>
                    <p class="mb-20">These epass2003 USB tokens, widely used for storing or downloading any kind of digital signature certificates, It is based on a smart-card chip and are easy to carry anywhere. ePass2003 can be installed on Windows, Mac and Linux operating systems, With the standards of x.509 v3 certificate storage makes it easy for the user to encrypt or decrypt the shared or signed information at an ease. Thus, helps in making their entire signing process easy and quick.</p>
                </div> 
                <div class="col-sm-12 mb-20">
                    <h5 class="mb-5 font-16 font-weight-600">
            ...
            <div class="d-flex align-items-center  offset-md-1 mt-50 ">
                <img class="img-fluid" src="{{ asset('dist/img/home-banner/dsc/types-of-usb-token.jpg') }}" alt="Who Can Apply for Digital Certificate"/>
            </div>
        </div>
        </div>
    </div>
